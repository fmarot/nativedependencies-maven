...
* make the plugin recognizable in Eclipse with no error from m2e (even if m2e makes nothins about it) => to check, I think it works correctly as is
...
* update Eclipse plugin to match current Eclipse V4 standards
