...
//		artifactHandler = context.mock(IArtifactHandler.class);
//		mojo.setArtifactHandler(artifactHandler);
...
//				oneOf(mavenProject).getArtifacts();
//				will(returnValue(artifacts));
//				oneOf(artifactHandler).moveOrUnpackTo(nativesTargetDir, nativeArtifact);
//			}
//		});
//
//		mojo.execute();
